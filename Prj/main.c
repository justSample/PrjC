...
void MainLogic() {
    ...
    while(1)
    {
        ...
        printf("2. Добавление новой партии\n");
        printf("3. Удаление партии\n");
        printf("4. Поиск\n");
        printf("5. Сохранить\n");
        printf("6. Загрузить\n");
...
//  2. Поиск трёх игроков с наибольшим количеством набранных очков [OK]
//  3. Наиболее долгая партия по заданной подстроке наименования дебюта. (Поиск по названию дебюта) [OK]